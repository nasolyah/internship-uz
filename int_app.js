...
(function () {
  ...
  /* Карточка наверху кабинета. Сначала она показывала ещё и следующий шаг, но
     после появления плавающей панели это стало дублированием: одно и то же в
     двух местах на одном экране. Шаги отданы панели, здесь осталось только
     событие, которому в списке шагов не место, — выданная справка. */
  function nextStepCard() {
    ...
    /* Шаги сюда больше не попадают: их целиком показывает плавающая панель,
       и одно и то же в двух местах — лишняя работа для глаз. Карточка
       осталась ради единственного события, которому в панели не место. */
    return '';
  }
